...
config = load_config()
bot = telebot.TeleBot(config['7255621314:AAFYTrsoXuQqyO6zXRYAwjynPBFEQKKMJYw'])
ADMIN_IDS = set(config['6987108806'])
...
# Bot command handlers
import shutil
# SCRIPT MADE BY @BGMIxDARK07 ON TELEGRAM THIS IS A PAID SCRIPT MOST POWERFULL A DDOS TELEGRAM BOT SCRIPT
# SCRIPT MADE BY @BGMIxDARK07 ON TELEGRAM THIS IS A PAID SCRIPT MOST POWERFULL A DDOS TELEGRAM BOT SCRIPT

...
config = load_config()
bot = telebot.TeleBot(config['6846146512:AAHh1UgXLgOYq07AOORQmLaggRt5-HFYytI'])
ADMIN_IDS = set(config['1909396218'])
USER_FILE = config['user_file']
LOG_FILE = config['log_file']
COOLDOWN_TIME = config['cooldown_time']
USER_COOLDOWN = 00 # Cooldown time for normal users in seconds
